  ...
  return (
    <div className="min-h-screen bg-[#08080E] flex flex-col items-center justify-center px-6 text-center">
      ...
      >
        ...
        <h1 className="text-[24px] font-semibold text-white/80 mb-3 -mt-6">Page not found</h1>
        <p className="text-[14px] text-white/35 max-w-sm mx-auto mb-8 leading-relaxed">
          This page doesn't exist. The context graph has no record of it either.
        </p>
        <Link to="/">
          <button className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-primary text-[13px] font-medium text-white hover:bg-primary/90 transition-all mx-auto shadow-[0_0_20px_rgba(99,102,241,0.25)]">
